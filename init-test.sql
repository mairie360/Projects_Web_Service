-- Seed minimal pour les tests isolés (performance / sécurité) du front Projects.
...
-- (sinon 502 côté BFF User, que BFF_Project appelle, donc sur /projects-page et sur le shell du front).
