...
// Reconstruit le contrat OpenAPI de BFF_Project à partir du paquet @mairie360/bff-project-openapi installé
...
export const PACKAGE_NAME = '@mairie360/bff-project-openapi';
...
function readOperation(operationId, fn, models) {
  ...
  // La fabrique `getBffProject` et les helpers `getXUrl` n'ont pas ce type de retour.
